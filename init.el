...
;; Update recipe repositories every 7 days, without blocking startup.
;; If the stamp is stale, ask whether to pull as soon as Emacs goes idle
;; after startup. This keeps the prompt off the startup path so the editor
